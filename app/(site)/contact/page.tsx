...
export default async function ContactPage() {
  ...
  const show = (key: keyof typeof content.visibility) =>
    isSectionVisible(content.visibility, key);

  const showMainSection =
    show("contactDetails") || show("enquiryForm") || show("map");
          ...
          <div className="wrap contact-layout">
            {show("contactDetails") ? (
              <div className="contact-details-panel">
                <span className="eyebrow">{content.formPlaceholder.detailsEyebrow}</span>
            ...
            {show("enquiryForm") || show("map") ? (
              <div className="contact-side-panel">
                ...
                {show("map") && content.details.mapEmbedUrl ? (
                ...
                ) : show("map") && content.details.mapUrl ? (
